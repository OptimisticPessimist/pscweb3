...
async def get_project_dashboard(
    ...
    """
    now = datetime.now(UTC)  # UTC aware for correct comparison with DB values
    ...
    rehearsal_stmt = (
        ...
        .where(RehearsalSchedule.project_id == project_id, Rehearsal.date >= now)
    ...
    milestone_stmt = (
        select(Milestone)
        .where(Milestone.project_id == project_id, Milestone.start_date >= now)
