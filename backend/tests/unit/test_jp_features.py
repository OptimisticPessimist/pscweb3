...
from src.db.models import Line, Scene, Script, TheaterProject, User
...
"""
    ...
    result = await db.execute(
        ...
        .options(selectinload(Script.scenes).selectinload(Scene.lines).selectinload(Line.character))
    )
