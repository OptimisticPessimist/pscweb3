        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-900 text-white">
            <div className="max-w-md w-full space-y-8 p-10 bg-gray-800 rounded-xl shadow-2xl">
                <div className="text-center">
                    <h2 className="mt-6 text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">
                        {t('auth.welcome')}
                    </h2>
                ...
                <div className="mt-8 space-y-6">
                    ...
                    >
                        <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                            {/* Discord Logo Icon */}
                            <svg
                                className="h-5 w-5 text-indigo-200 group-hover:text-white transition-colors duration-200"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                                aria-hidden="true"
                            >
